...
const Renderer = ({ items }: RendererProps<ImageConvertQueueItem>) => {
    ...
    <>
      ...
      <PaginatedView<ImageConvertQueueItem>
        ...
        urlWithSubViewNameAndPageNumberVar={
          '/admin/queues/image-convert/:subViewName/page/:pageNumber'
        }
        subViews={[
          {
            id: SubView.Queued,
