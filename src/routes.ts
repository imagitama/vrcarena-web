...
export const viewAssetAmendments = '/asset-amendments'
export const createAssetAmendmentWithVar = '/asset-amendments/create/:assetId'
export const viewAssetAmendmentWithVar = '/asset-amendments/:amendmentId'
export const editAssetAmendmentWithVar = '/asset-amendments/:amendmentId/edit'
