...
export const editableFields: EditableField<Species>[] = [
  ...
  // automatically generated by SQL cron job 16aug2026
  // {
  //   name: 'thumbnailurl',
  //   label: 'Thumbnail',
  ...
  // },
  {
    ...
    label: 'Slug',
    type: fieldTypes.text,
    hint: 'Automatically generated when creating a species (so leave blank). This should never be edited as it will break search engine results.',
    allowEmpty: true,
  },
]
