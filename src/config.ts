...
export const DEFAULT_PAGE_DESC =
  'An open-source, not-for-profit community project to document, tag and categorize every asset for VR social games such as VRChat, ChilloutVR and Resonite.'

export const VRCHAT_GROUP_ID = 'ARENA.9705'
...
export const loginWithDiscordUrl = `https://discord.com/api/oauth2/authorize?client_id=${process.env.REACT_APP_DISCORD_CLIENT_ID}&redirect_uri=${process.env.REACT_APP_DISCORD_LOGIN_REDIRECT_URI}&response_type=code&scope=identify%20email&prompt=none`
